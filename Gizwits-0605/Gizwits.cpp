...
void Gizwits::write(VALUE_TYPE_T valueType, uint32_t value)
{
	switch(valueType)
	{
		case VALUE_Temperature:
			currentDataPoint.valueTemperature = value;
		break;
		case VALUE_Humidity:
			currentDataPoint.valueHumidity = value;
		break;
		case VALUE_Altitude:
			currentDataPoint.valueAltitude = value;
		break;
		case VALUE_Windspeed:
			currentDataPoint.valueWindspeed = value;
		break;
		case VALUE_Rainfall:
			currentDataPoint.valueRainfall = value;
		break;
		case VALUE_Pressure:
			currentDataPoint.valuePressure = value;
		break;
		case VALUE_Lux:
			currentDataPoint.valueLux = value;
		break;
		default:
			break;
	}
