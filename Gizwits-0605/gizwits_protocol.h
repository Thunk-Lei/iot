...
#define Altitude_RATIO                         1
#define Altitude_ADDITION                      0
#define Altitude_MIN                           0
#define Altitude_MAX                           5000
#define Windspeed_RATIO                         0.05
#define Windspeed_ADDITION                      0
#define Windspeed_MIN                           0
#define Windspeed_MAX                           1200
#define Rainfall_RATIO                         1
#define Rainfall_ADDITION                      0
#define Rainfall_MIN                           0
#define Rainfall_MAX                           1023
#define Pressure_RATIO                         0.01
#define Pressure_ADDITION                      0
#define Pressure_MIN                           0
#define Pressure_MAX                           100000
#define Lux_RATIO                         1
...
typedef struct {
  ...
  uint32_t valueAltitude;
  float valueWindspeed;
  uint32_t valueRainfall;
  float valuePressure;
  uint32_t valueLux;
} dataPoint_t;
...
typedef struct {
  ...
  uint16_t valueAltitude;
  uint16_t valueWindspeed;
  uint16_t valueRainfall;
  uint32_t valuePressure;
  uint32_t valueLux;
} devStatus_t; 
